	...
	<!-- ---------------------------- view Prisoer Column 1 --------------------------------------- -->
						<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<p class="form-control-static" id="licenseNumber"><?= $prisoner->license_number; ?></p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<p class="form-control-static" id="middleName"><?= $prisoner->middle_name; ?></p>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-4 control-label"><?= $this->lang->line('last_name'); ?></label>
								<div class="col-sm-8">
									<p class="form-control-static" id="lastName"><?= $prisoner->last_name; ?></p>
								</div>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<p class="form-control-static" id="eyeColor"><?= $prisoner->eye_color; ?></p>
								</div>
							</div>
							<div class="form-group">
