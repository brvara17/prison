...
-- -----------------------------------------------------
-- Table `prison`.`eye_color`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `prison`.`eye_color` ;

CREATE TABLE IF NOT EXISTS `prison`.`eye_color` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `prison`.`hair_color`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `prison`.`hair_color` ;

CREATE TABLE IF NOT EXISTS `prison`.`hair_color` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `status_english` VARCHAR(45) NULL,
  `status_dari` VARCHAR(45) NULL,
  `status_pashto` VARCHAR(45) NULL,
...
-- -----------------------------------------------------
-- Table `prison`.`prisoner` Edit 11/28
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `prison`.`prisoner` (
  ...
  `birth_city` VARCHAR(70) NULL,
  `birth_country` VARCHAR(70) NULL,
  `ssn` VARCHAR(70) NULL,
  `sex` VARCHAR(70) NULL,
  `height_feet` INT NULL,
  `height_inches` INT NULL,
  `weight` INT NULL,
  `property_management` VARCHAR(200) NULL,
  `age` INT NULL,
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_prisoner_eye_color1_idx` (`eye_color_id` ASC),
  INDEX `fk_prisoner_hair_color1_idx` (`hair_color_id` ASC),
  ...
  CONSTRAINT `fk_prisoner_eye_color1`
    FOREIGN KEY (`eye_color_id`)
    REFERENCES `prison`.`eye_color` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_prisoner_hair_color1`
    FOREIGN KEY (`hair_color_id`)
    REFERENCES `prison`.`hair_color` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `prisoner_view` AS select `prisoner`.`id` AS `id`,`prisoner`.`license_number` AS `license_number`,`prisoner`.`eye_color_id` AS `eye_color_id`,`eye_color`.`status_english` AS `eye_color_english`,`eye_color`.`status_dari` AS `eye_color_dari`,`eye_color`.`status_pashto` AS `eye_color_pashto`,`prisoner`.`hair_color_id` AS `hair_color_id`,`hair_color`.`status_english` AS `hair_color_english`,`hair_color`.`status_dari` AS `hair_color_dari`,`hair_color`.`status_pashto` AS `hair_color_pashto`,`prisoner`.`present_province_id` AS `present_province_id`,`present_province`.`name_english` AS `present_province_english`,`present_province`.`name_dari` AS `present_province_dari`,`present_province`.`name_pashto` AS `present_province_pashto`,`prisoner`.`present_district_id` AS `present_district_id`,`present_district`.`name_english` AS `present_district_english`,`present_district`.`name_dari` AS `present_district_dari`,`present_district`.`name_pashto` AS `present_district_pashto`,`prisoner`.`permanent_province_id` AS `permanent_province_id`,`permanent_province`.`name_english` AS `permanent_province_english`,`permanent_province`.`name_dari` AS `permanent_province_dari`,`permanent_province`.`name_pashto` AS `permanent_province_pashto`,`prisoner`.`permanent_district_id` AS `permanent_district_id`,`permanent_district`.`name_english` AS `permanent_district_english`,`permanent_district`.`name_dari` AS `permanent_district_dari`,`permanent_district`.`name_pashto` AS `permanent_district_pashto`,`prisoner`.`name` AS `name`,`prisoner`.`middle_name` AS `middle_name`,`prisoner`.`last_name` AS `last_name`,`prisoner`.`street_num` AS `street_num`,`prisoner`.`street_name` AS `street_name`,`prisoner`.`apartment_num` AS `apartment_num`,`prisoner`.`city` AS `city`,`prisoner`.`zipcode` AS `zipcode`,`prisoner`.`phone` AS `phone`,`prisoner`.`birth_city` AS `birth_city`,`prisoner`.`birth_country` AS `birth_country`,`prisoner`.`ssn` AS `ssn`,`prisoner`.`sex` AS `sex`,`prisoner`.`height_feet` AS `height_feet`,`prisoner`.`height_inches` AS `height_inches`,`prisoner`.`weight` AS `weight`,`prisoner`.`property_management` AS `property_management`,`prisoner`.`age` AS `age`,`prisoner`.`criminal_history` AS `criminal_history`,`prisoner`.`num_of_children` AS `num_of_children`,`prisoner`.`profile_pic` AS `profile_pic`,`prisoner`.`locked` AS `locked` from ((((((`prisoner` join `eye_color` on((`eye_color`.`id` = `prisoner`.`eye_color_id`))) join `hair_color` on((`hair_color`.`id` = `prisoner`.`hair_color_id`))) join `province` `present_province` on((`present_province`.`id` = `prisoner`.`present_province_id`))) join `district` `present_district` on((`present_district`.`id` = `prisoner`.`present_district_id`))) join `province` `permanent_province` on((`permanent_province`.`id` = `prisoner`.`permanent_province_id`))) join `district` `permanent_district` on((`permanent_district`.`id` = `prisoner`.`permanent_district_id`))) order by `prisoner`.`id`;
...
`prisoner`.`id` AS `id`,
`prisoner`.`license_number` AS `license_number`,
`prisoner`.`eye_color_id` AS `eye_color_id`,
`eye_color`.`status_english` AS `eye_color_english`,
`eye_color`.`status_dari` AS `eye_color_dari`,
`eye_color`.`status_pashto` AS `eye_color_pashto`,
...
`prisoner`.`middle_name` AS `middle_name`,
`prisoner`.`last_name` AS `last_name`,
`prisoner`.`age` AS `age`,
...
`prisoner`.`locked` AS `locked`
 from `prisoner` 
 INNER JOIN `eye_color` ON `eye_color`.`id` = `prisoner`.`eye_color_id`
...
-- Edit 11/28
 ...
 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `general_view` AS select `prisoner`.`license_number` AS `license_number`,`prisoner`.`eye_color_id` AS `eye_color_id`,`eye_color`.`status_english` AS `eye_color_english`,`eye_color`.`status_dari` AS `eye_color_dari`,`eye_color`.`status_pashto` AS `eye_color_pashto`,`prisoner`.`hair_color_id` AS `hair_color_id`,`hair_color`.`status_english` AS `hair_color_english`,`hair_color`.`status_dari` AS `hair_color_dari`,`hair_color`.`status_pashto` AS `hair_color_pashto`,`prisoner`.`present_province_id` AS `present_province_id`,`present_province`.`name_english` AS `present_province_english`,`present_province`.`name_dari` AS `present_province_dari`,`present_province`.`name_pashto` AS `present_province_pashto`,`prisoner`.`present_district_id` AS `present_district_id`,`present_district`.`name_english` AS `present_district_english`,`present_district`.`name_dari` AS `present_district_dari`,`present_district`.`name_pashto` AS `present_district_pashto`,`prisoner`.`permanent_province_id` AS `permanent_province_id`,`permanent_province`.`name_english` AS `permanent_province_english`,`permanent_province`.`name_dari` AS `permanent_province_dari`,`permanent_province`.`name_pashto` AS `permanent_province_pashto`,`prisoner`.`permanent_district_id` AS `permanent_district_id`,`permanent_district`.`name_english` AS `permanent_district_english`,`permanent_district`.`name_dari` AS `permanent_district_dari`,`permanent_district`.`name_pashto` AS `permanent_district_pashto`,`prisoner`.`name` AS `name`,`prisoner`.`middle_name` AS `middle_name`,`prisoner`.`last_name` AS `last_name`,`prisoner`.`street_num` AS `street_num`,`prisoner`.`street_name` AS `street_name`,`prisoner`.`apartment_num` AS `apartment_num`,`prisoner`.`city` AS `city`,`prisoner`.`zipcode` AS `zipcode`,`prisoner`.`phone` AS `phone`,`prisoner`.`birth_city` AS `birth_city`,`prisoner`.`birth_country` AS `birth_country`,`prisoner`.`ssn` AS `ssn`,`prisoner`.`sex` AS `sex`,`prisoner`.`height_feet` AS `height_feet`,`prisoner`.`height_inches` AS `height_inches`,`prisoner`.`weight` AS `weight`,`prisoner`.`property_management` AS `property_management`,`prisoner`.`age` AS `age`,`prisoner`.`criminal_history` AS `criminal_history`,`prisoner`.`num_of_children` AS `num_of_children`,`prisoner`.`profile_pic` AS `profile_pic`,`crime`.`registration_date` AS `registration_date`,`crime`.`case_number` AS `case_number`,`crime`.`crime_date` AS `crime_date`,`crime`.`crime_date_shamsi` AS `crime_date_shamsi`,`crime`.`arrest_date` AS `arrest_date`,`crime`.`arrest_date_shamsi` AS `arrest_date_shamsi`,`crime`.`crime_reason` AS `crime_reason`,`crime`.`crime_supporter` AS `crime_supporter`,`crime`.`crime_location` AS `crime_location`,`crime`.`arrest_location` AS `arrest_location`,`crime`.`police_custody` AS `police_custody`,`crime`.`crime_province_id` AS `crime_province_id`,`crime_province`.`name_english` AS `crime_province_english`,`crime_province`.`name_dari` AS `crime_province_dari`,`crime_province`.`name_pashto` AS `crime_province_pashto`,`crime`.`crime_district_id` AS `crime_district_id`,`crime_district`.`name_english` AS `crime_district_english`,`crime_district`.`name_dari` AS `crime_district_dari`,`crime_district`.`name_pashto` AS `crime_district_pashto`,`crime`.`arrest_province_id` AS `arrest_province_id`,`arrest_province`.`name_english` AS `arrest_province_english`,`arrest_province`.`name_dari` AS `arrest_province_dari`,`arrest_province`.`name_pashto` AS `arrest_province_pashto`,`crime`.`arrest_district_id` AS `arrest_district_id`,`arrest_district`.`name_english` AS `arrest_district_english`,`arrest_district`.`name_dari` AS `arrest_district_dari`,`arrest_district`.`name_pashto` AS `arrest_district_pashto`,`crime`.`time_spent_in_prison` AS `time_spent_in_prison`,`crime`.`remaining_jail_term` AS `remaining_jail_term`,`crime`.`use_benefit_forgiveness_presidential` AS `use_benefit_forgiveness_presidential`,`crime`.`command_issue_date` AS `command_issue_date`,`crime`.`command_issue_date_shamsi` AS `command_issue_date_shamsi`,`crime`.`commission_proposal` AS `commission_proposal`,`crime`.`prisoner_request` AS `prisoner_request`,`crime`.`commission_member` AS `commission_member`,`crime`.`locked` AS `locked`,(select group_concat(`crime_type`.`type_name_dari` separator ',') from (`crime_type` join `crime_crime_type` on((`crime_crime_type`.`crime_type_id` = `crime_type`.`id`))) where (`crime_crime_type`.`crime_id` = `crime_prisoner`.`crime_id`)) AS `crime_type_dari`,(select group_concat(`crime_type`.`type_name_pashto` separator ',') from (`crime_type` join `crime_crime_type` on((`crime_crime_type`.`crime_type_id` = `crime_type`.`id`))) where (`crime_crime_type`.`crime_id` = `crime_prisoner`.`crime_id`)) AS `crime_type_pashto`,(select group_concat(`crime_type`.`type_name_english` separator ',') from (`crime_type` join `crime_crime_type` on((`crime_crime_type`.`crime_type_id` = `crime_type`.`id`))) where (`crime_crime_type`.`crime_id` = `crime_prisoner`.`crime_id`)) AS `crime_type_english`,`crime_prisoner`.`prisoner_id` AS `prisoner_id`,`crime_prisoner`.`crime_id` AS `crime_id` from ((((((((((((`prisoner` join `eye_color` on((`eye_color`.`id` = `prisoner`.`eye_color_id`))) join `hair_color` on((`hair_color`.`id` = `prisoner`.`hair_color_id`))) join `province` `present_province` on((`present_province`.`id` = `prisoner`.`present_province_id`))) join `district` `present_district` on((`present_district`.`id` = `prisoner`.`present_district_id`))) join `province` `permanent_province` on((`permanent_province`.`id` = `prisoner`.`permanent_province_id`))) join `district` `permanent_district` on((`permanent_district`.`id` = `prisoner`.`permanent_district_id`))) join `crime_prisoner` on((`crime_prisoner`.`prisoner_id` = `prisoner`.`id`))) join `crime` on((`crime`.`id` = `crime_prisoner`.`crime_id`))) join `province` `crime_province` on((`crime_province`.`id` = `crime`.`crime_province_id`))) join `district` `crime_district` on((`crime_district`.`id` = `crime`.`crime_district_id`))) join `province` `arrest_province` on((`arrest_province`.`id` = `crime`.`arrest_province_id`))) join `district` `arrest_district` on((`arrest_district`.`id` = `crime`.`arrest_district_id`))) order by `crime_prisoner`.`crime_id`;
...
(select group_concat(type_name_dari) from crime_type
inner join crime_crime_type on crime_crime_type.crime_type_id=crime_type.id
where crime_crime_type.crime_id=`crime_prisoner`.`crime_id`) as crime_type_dari,

(select group_concat(type_name_pashto) from crime_type
inner join crime_crime_type on crime_crime_type.crime_type_id=crime_type.id
where crime_crime_type.crime_id=`crime_prisoner`.`crime_id`) as crime_type_pashto,

(select group_concat(type_name_english) from crime_type
inner join crime_crime_type on crime_crime_type.crime_type_id=crime_type.id
where crime_crime_type.crime_id=`crime_prisoner`.`crime_id`) as crime_type_english,
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `general_quick_view` AS select `prisoner`.`license_number` AS `license_number`,`prisoner`.`eye_color_id` AS `eye_color_id`,`eye_color`.`status_english` AS `eye_color_english`,`eye_color`.`status_dari` AS `eye_color_dari`,`eye_color`.`status_pashto` AS `eye_color_pashto`,`prisoner`.`hair_color_id` AS `hair_color_id`,`hair_color`.`status_english` AS `hair_color_english`,`hair_color`.`status_dari` AS `hair_color_dari`,`hair_color`.`status_pashto` AS `hair_color_pashto`,`prisoner`.`permanent_province_id` AS `permanent_province_id`,`permanent_province`.`name_english` AS `permanent_province_english`,`permanent_province`.`name_dari` AS `permanent_province_dari`,`permanent_province`.`name_pashto` AS `permanent_province_pashto`,`prisoner`.`permanent_district_id` AS `permanent_district_id`,`permanent_district`.`name_english` AS `permanent_district_english`,`permanent_district`.`name_dari` AS `permanent_district_dari`,`permanent_district`.`name_pashto` AS `permanent_district_pashto`,`prisoner`.`name` AS `name`,`prisoner`.`middle_name` AS `middle_name`,`prisoner`.`last_name` AS `last_name`,`prisoner`.`street_num` AS `street_num`,`prisoner`.`street_name` AS `street_name`,`prisoner`.`apartment_num` AS `apartment_num`,`prisoner`.`city` AS `city`,`prisoner`.`zipcode` AS `zipcode`,`prisoner`.`phone` AS `phone`,`prisoner`.`birth_city` AS `birth_city`,`prisoner`.`birth_country` AS `birth_country`,`prisoner`.`ssn` AS `ssn`,`prisoner`.`sex` AS `sex`,`prisoner`.`height_feet` AS `height_feet`,`prisoner`.`height_inches` AS `height_inches`,`prisoner`.`weight` AS `weight`,`prisoner`.`property_management` AS `property_management`,`prisoner`.`age` AS `age`,`prisoner`.`criminal_history` AS `criminal_history`,`crime`.`registration_date` AS `registration_date`,`crime`.`case_number` AS `case_number`,`crime`.`crime_date` AS `crime_date`,`crime`.`crime_date_shamsi` AS `crime_date_shamsi`,`crime`.`arrest_date` AS `arrest_date`,`crime`.`arrest_date_shamsi` AS `arrest_date_shamsi`,`crime`.`crime_reason` AS `crime_reason`,`crime`.`crime_supporter` AS `crime_supporter`,`crime`.`police_custody` AS `police_custody`,`crime`.`time_spent_in_prison` AS `time_spent_in_prison`,`crime`.`remaining_jail_term` AS `remaining_jail_term`,`crime`.`locked` AS `locked`,`crime_prisoner`.`prisoner_id` AS `prisoner_id`,`crime_prisoner`.`crime_id` AS `crime_id` from ((((((`prisoner` join `eye_color` on((`eye_color`.`id` = `prisoner`.`eye_color_id`))) join `hair_color` on((`hair_color`.`id` = `prisoner`.`hair_color_id`))) join `province` `permanent_province` on((`permanent_province`.`id` = `prisoner`.`permanent_province_id`))) join `district` `permanent_district` on((`permanent_district`.`id` = `prisoner`.`permanent_district_id`))) join `crime_prisoner` on((`crime_prisoner`.`prisoner_id` = `prisoner`.`id`))) join `crime` on((`crime`.`id` = `crime_prisoner`.`crime_id`))) order by `crime_prisoner`.`crime_id`;
...
INSERT INTO `eye_color` (`id`, `status_english`, `status_dari`, `status_pashto`) VALUES
(1, 'Amber','مجرد','مجرد'),
(2, 'Blue','متاهل','متاهل'),
(3, 'Brown','بیوه','کونډه'),
(4, 'Gray','نامزد','نامزد'),
(5, 'Green','نامزد','نامزد'),
(6, 'Hazel','نامزد','نامزد'),
(7, 'Red and Violet','نامزد','نامزد');

--
-- Dumping data for table `hair_color`
--

INSERT INTO `hair_color` (`id`, `status_english`, `status_dari`, `status_pashto`) VALUES
(1, 'Blonde','مجرد','مجرد'),
(2, 'Brunette','متاهل','متاهل'),
(3, 'Black','بیوه','کونډه'),
(4, 'Gray','نامزد','نامزد'),
(5, 'Green','نامزد','نامزد'),
(6, 'Red','نامزد','نامزد'),
